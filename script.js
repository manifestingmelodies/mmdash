...
const chatMessages = [
  { user: "Maria J.", content: "The melody helped me manifest $1,000 last night! Found a forgotten check in my drawer!", time: "Just now", avatar: "#EC4899", likes: 5 },
  { user: "Jason T.", content: "Day 9 - already seeing amazing results! My business is up 27% this month", time: "1m ago", avatar: "#10B981", likes: 3 },
  { user: "Debbie K.", content: "First night without seeing 3AM in 15 years after listening to this melody!", time: "3m ago", avatar: "#3B82F6" },
  { user: "Thomas W.", content: "Lost 3 pounds this week just by listening to the melody daily!", time: "4m ago", avatar: "#F59E0B" },
  { user: "Jennifer S.", content: "Dropped two dress sizes without trying! This actually works people!", time: "5m ago", avatar: "#8B5CF6", likes: 8 },
  { user: "Wesley V.", content: "Generated a million-dollar idea on day 7. Already started implementing!", time: "6m ago", avatar: "#4F46E5" },
  { user: "Elizabeth K.", content: "My blood pressure is down 15 points in just 5 days of listening!", time: "8m ago", avatar: "#06B6D4" },
  { user: "Jason M.", content: "Found forgotten $27,840 check in an old box after day 5!", time: "11m ago", avatar: "#DC2626", likes: 12 }
];

// More messages that can be dynamically added
const additionalMessages = [
  { user: "Greg L.", content: "Day 21 complete! Got a $5,430 unexpected refund today!", avatar: "#10B981" },
  { user: "Tom K.", content: "Anyone notice improved relationship with spouse after using this?", avatar: "#3B82F6" },
  ...
  { user: "Sarah K.", content: "Just referred my sister. This is too good not to share!", avatar: "#9333EA" },
  { user: "Ryan D.", content: "Morning everyone! Day 5 and already feeling the difference in my mood!", avatar: "#14B8A6" },
  ...
  { user: "Jessica R.", content: "I feel so much lighter and happier after just 3 days of listening!", avatar: "#F472B6" },
  { user: "Daniel H.", content: "Found a forgotten $1,200 check in my drawer yesterday. This actually works!", avatar: "#2563EB" },
  { user: "Karen L.", content: "Dropped 3 dress sizes without even trying! This is amazing!", avatar: "#DC2626" },
  { user: "Robert A.", content: "My business is up 34% since I started listening last month!", avatar: "#059669" },
  { user: "Sophia W.", content: "First night without seeing 3AM in 15 years. Thank you!", avatar: "#7C3AED" }
];
